...
# ── CSS with improved visibility for inputs ────────────────────────────────────
def load_css():
    st.markdown("""
    <style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    /* ========== INPUTS - FORCE VISIBILITY ========== */
    /* Number inputs - dark text on white background */
    ...
    /* Select boxes (section & réseau) - green text but visible */
